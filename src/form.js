...
export default class Form extends React.Component {
  ...
  handleSubmit(event) {
    ...
    if (this.props.card().cardId) {
      newCard.cardId = this.props.card().cardId
    }
        ...
        <div className="card-body">
          <form onSubmit={this.handleSubmit}>
            <div className="form-group text-left">
              ...
              {this.props.mode === 'edit' && <input name="question" type="text" id="inputQuestion" className="form-control" defaultValue={this.props.card().question}/>}
            </div>
            <div className="form-group text-left">
              ...
              {this.props.mode === 'edit' && <input type="text" id="inputAnswer" name="answer" className="form-control" defaultValue={this.props.card().answer}/>}
            </div>
