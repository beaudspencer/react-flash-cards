      ...
      <div className="card-body">
        <form onSubmit={props.submit}>
          <div className="form-group text-left">
            ...
            <input name="question" type="text" id="questionInput" size="28" placeholder="Enter card question here"/>
          </div>
          <div className="form-group text-left">
            <label htmlFor="inputAnswer" className="mr-2">Answer:</label>
            <input type="text" id="answerInput" name="answer" size="28" placeholder="Enter card answer here"/>
          </div>
